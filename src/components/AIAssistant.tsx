            ...
            <div className="p-4 border-t">
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button onClick={handleSendMessage} disabled={!inputValue.trim() || isTyping} className="bg-gradient-to-r from-primary to-accent hover:from-accent hover:to-primary transition-all shadow-md">
